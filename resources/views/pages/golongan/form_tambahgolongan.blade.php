...
<div class="row">
	...
	<!-- jquery validation -->
		<div class="card card-primary">
		  ...
		  <!-- /.card-header -->
		  <!-- form start -->
		  <form role="form" id="tambahgolongan" method="post" action="{{url('prosestambahgolongan')}}" >
		  	{{ csrf_field() }}
				...
				<div class="row">
                  ...
                  @endif
				      ...
				      <div class="form-group">
				        ...
				        <input type="text" name="nama" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" id="txtNama" value="{{old('nama') }}" placeholder="Nama Golongan">
				      </div>
				      <div class="form-group">
