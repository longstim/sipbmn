...
@section('page_heading','Daftar Lembur per Bulan')
@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
  <li class="breadcrumb-item"><a href="{{url('lembur')}}">Lembur Pegawai</a></li>
  <li class="breadcrumb-item active">Daftar Lembur per Bulan</li>
</ol>
@endsection
@section('content')
<style>
  ...
  <div class="row">
    <div class="col-12">
     <form role="form" id="daftarlemburpegawaiform" method="post" action="{{url('daftarlemburperbulan')}}" >
        {{ csrf_field() }}
        ...
        <div class="col-sm-8 row">
          ...
          <div class="col-sm-8">
              <select onchange="this.form.submit()" name="pegawai" id="slcPegawai" class="form-control select2bs4" style="width: 100%;">
                  ...
                  <option value="" @if($data->id == $id_pegawai) selected @endif>{{$data->nama}}</option>
              </select>
          </div>
        </div>
        <div class="col-sm-4">
