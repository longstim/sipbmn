...
@section('page_heading','Daftar Approval Peminjaman')
@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
  <li class="breadcrumb-item active">Daftar Approval Peminjaman</li>
</ol>
@endsection
@section('content')
<style>
          ...
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            @foreach($peminjaman as $data)  
               <tr>
                  ...
                  <td>
                    <div class="btn-group">
                        <a href="approvalpeminjaman/{{$data['id']}}" data-toggle="tooltip" data-placement="top" title="Approval"><i class="far fa-check-square fa-lg" aria-hidden="true"></i></a>                   
                    </div>
                  </td>
               </tr>
            @endforeach
