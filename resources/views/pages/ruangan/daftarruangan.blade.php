...
@section('page_heading','Daftar Ruangan')
@section('breadcrumb')
...
<style>
  ...
  <div class="row">
    <div class="col-12">
      <a href="{{ url('/tambahruangan') }}" class="btn btn-primary btn-md" role="button">Tambah</a>
      <p></p>
      <div>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" id="dropdown-action-id">
                        <a class="dropdown-item" href="ubahruangan/{{$data->id}}">Ubah Data</a>
                        <a class="dropdown-item swalDelete" href="hapusruangan/{{$data->id}}">Hapus Data</a>
                      </div>
                    </div>
                  </td>
               </tr>
