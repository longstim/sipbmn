...
@section('page_heading','Daftar Sub Sub Kelompok BMN')
@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
  <li class="breadcrumb-item active">Daftar Sub Sub Kelompok BMN</li>
</ol>
@endsection
@section('content')
<style>
  ...
  <div class="row">
    <div class="col-12">
      <a href="{{ url('/tambahsubsubkelompokbmn') }}" class="btn btn-primary btn-md" role="button">Tambah</a>
      <p></p>
      <div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            $no = 0
            @endphp
            @foreach($subsubkelompokbmn as $data)  
               <tr>
                  <td>{{++$no}}</td>
                  <td>{{$data->id}}</td>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" id="dropdown-action-id">
                        <a class="dropdown-item" href="ubahsubsubkelompokbmn/{{$data->id}}">Ubah Data</a>
                        <a class="dropdown-item swalDelete" href="hapussubsubkelompokbmn/{{$data->id}}">Hapus Data</a>
                      </div>
                    </div>
                  </td>
               </tr>
